...
def read_local_config(config_file, file_logger):
    ...
    # host address type (ipv4 or ipv6)
    config_vars['splunk_host_ip_type'] = gen_sect.get('splunk_host_ip_type', 'ipv4')
    # host port
    ...
    config_vars['influx_host_ip_type'] = gen_sect.get('influx_host_ip_type', 'ipv4')
    ...
    config_vars['influx2_host_ip_type'] = gen_sect.get('influx2_host_ip_type', 'ipv4')
    ...
    if config_vars['exporter_type'] == 'splunk':
        ...
        config_vars['data_host_ip_type'] = config_vars['splunk_host_ip_type']
        ...
        config_vars['data_host_ip_type'] = config_vars['influx_host_ip_type']
        ...
        config_vars['data_host_ip_type'] = config_vars['influx2_host_ip_type']
    ...
    config_vars['network_data_file'] = network_sect.get('network_data_file', 'wiperf-network')
    ...
    for target_num in range(1, num_http_targets):
        ...
        config_vars[target_name_curl_args] = http_sect.get(target_name_curl_args, '')
