...
"""
import re
from wiperf_poller.helpers.route import resolve_name, is_ipv4, is_ipv6
...
class TestViabilityChecker(object):
    ...
    def check_test_host_viable(self, host):
        ...
        if re.match(r'\d+\.\d+\.\d+\.\d+', host):
            ...
            ip_address =  resolve_name(host, self.file_logger, ip_family="ipv4")
            ...
            ip_address =  resolve_name(host, self.file_logger, ip_family="ipv6")
