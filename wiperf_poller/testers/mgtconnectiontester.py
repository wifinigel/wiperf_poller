...
from wiperf_poller.helpers.route import check_correct_mgt_interface, inject_static_route
...
class MgtConnectionTester(object):
    ...
    def check_connection(self, watchdog_obj, lockf_obj):
        ...
        if not check_correct_mgt_interface(data_host, self.config_vars, self.file_logger):
            ...
            if inject_static_route(data_host, self.config_vars, self.file_logger):
